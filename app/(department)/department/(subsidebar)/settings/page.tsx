          ...
          <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
            <div className="relative my-4 w-56 sm:hidden">
              ...
              <ul className="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-md transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
                ...
                <li
                  onClick={() => handleTabClick("department-heads")}
                  className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white"
                >
                  Department Heads
                </li>
            ...
            <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
              ...
              {activeTab === "technician" && (
                <div className="pt-4">
                  ...
                  <p className="font text-slate-600">
                    View and manage technician details.
                  </p>
                  <hr className="mt-4 mb-8" />
                      ...
                      <tbody>
                        <tr className="border-b">
                          ...
                          <td className="py-2 px-4">
                            ...
                            <button className="text-rose-600" title="Delete">
                              🗑️
                            </button>
                          </td>
                        </tr>
              ...
              {activeTab === "department-heads" && (
                <div className="pt-4">
                  ...
                  <p className="font text-slate-600">
                    View and manage Department Head details.
                  </p>
                  <hr className="mt-4 mb-8" />
                  ...
                  <div className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
                    ...
                    <ul className="py-4 mt-2 text-gray-700 flex items-center justify-around">
                      <li className="flex flex-col items-center justify-around">
                        ...
                        <div className="flex justify-center">
                          <p className="text-sm">request's</p>
                        </div>
                      </li>
