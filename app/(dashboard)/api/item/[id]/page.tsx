...
export default function AssignId() {
  ...
  <div className="bg-slate-300 rounded-lg shadow-lg p-6 sm:p-8 lg:p-10 w-full">
    <h2 className="text-4xl font-extrabold mb-6 text-center text-gray-800">Assign Technician</h2>
    <p className="mb-6 text-center text-gray-600">
      This form is for assigning a technician for maintenance
    </p>
    <p className="mb-6 text-center text-gray-700">
      You are assigning a technician for <span className="font-bold text-gray-800">{reqInfo.requesterName}</span>'s Request?
    </p>
      ...
      <div className="bottom-data">
        <div className="orders">
          <div className="header flex items-center justify-center mb-6">
            ...
            <h3 className="ml-3 text-2xl font-semibold text-gray-800">View Request</h3>
          </div>
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="RequesterName" className="block mb-2 font-semibold text-gray-700">Requestor Name</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="PhoneNo" className="block mb-2 font-semibold text-gray-700">Phone No</label>
                <input
                  type="text"
                  className="border-gray-300 rounded-md px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-green-600"
                  id="PhoneNo"
              ...
              <div>
                <label htmlFor="DeviceType" className="block mb-2 font-semibold text-gray-700">Device Type</label>
                <input
                  type="text"
                  className="border-gray-300 rounded-md px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-green-600"
                  id="DeviceType"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="RequestType" className="block mb-2 font-semibold text-gray-700">Request Type</label>
                <input
                  type="text"
                  className="border-gray-300 rounded-md px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-green-600"
                  id="RequestType"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="ModelNo" className="block mb-2 font-semibold text-gray-700">Model No</label>
                <input
                  type="text"
                  className="border-gray-300 rounded-md px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-green-600"
                  id="ModelNo"
            ...
            <div>
                <label htmlFor="Urgency" className="block mb-2 font-semibold text-gray-700">Urgency</label>
                <input
                  type="text"
                  className="border-gray-300 rounded-md px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-green-600"
                  id="Urgency"
            ...
            <h2 className="text-4xl font-extrabold mb-6 text-center text-gray-800">Technician's Info</h2>
            <div>
            <table className="min-w-full bg-white border border-gray-200">
              ...
              <tbody>
                {TechnicianInfo.map((technician, index) => (
                  <tr key={index}>
                    <td className="py-2 px-7 text-center">{technician.technicianName}</td>
                    <td className="py-2 px-4 text-center">
                      ...
                      <button
                        className="bg-yellow-500 text-white font-bold py-2 px-6 rounded-full hover:bg-green-600 transition-colors"
                      >
            ...
            <div className="flex justify-center mt-6 space-x-4">
              ...
              <a href="/do_latter" onClick={handleDoLatter} className="bg-yellow-500 text-white font-bold py-2 px-6 rounded-lg hover:bg-yellow-600 transition-colors">
                Do Later
              </a>
            </div>
          </form>
