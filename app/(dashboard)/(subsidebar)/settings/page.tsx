            ...
            <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
                <div className="relative my-4 w-56 sm:hidden">
                    ...
                    <ul className="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-md transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
                        <li onClick={() => handleTabClick('theme')} className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white">Theme</li>
                        <li onClick={() => handleTabClick('accounts')} className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white">Accounts</li>
                        <li onClick={() => handleTabClick('technician')} className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white">Technician</li>
                        <li onClick={() => handleTabClick('department-heads')} className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white">Department Heads</li>
                        <li onClick={() => handleTabClick('notifications')}  className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white">Notifications</li>
                        <li onClick={() => handleTabClick('profile')}  className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white">Profile</li>
                    </ul>
                </div>

                <div className="col-span-2 hidden sm:block">
                    <ul>
                        <li onClick={() => handleTabClick('theme')} className={`mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeTab === 'theme' ? 'border-l-blue-700 text-blue-700' : 'border-transparent'}`}>Theme</li>
                        <li onClick={() => handleTabClick('accounts')} className={`mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeTab === 'accounts' ? 'border-l-blue-700 text-blue-700' : 'border-transparent'}`}>Accounts</li>
                        <li onClick={() => handleTabClick('technician')} className={`mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeTab === 'technician' ? 'border-l-blue-700 text-blue-700' : 'border-transparent'}`}>Technician</li>
                        <li onClick={() => handleTabClick('department-heads')} className={`mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeTab === 'department-heads' ? 'border-l-blue-700 text-blue-700' : 'border-transparent'}`}>Department Heads</li>
                        <li onClick={() => handleTabClick('notifications')} className={`mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeTab === 'notifications' ? 'border-l-blue-700 text-blue-700' : 'border-transparent'}`}>Notifications</li>
                        <li onClick={() => handleTabClick('profile')} className={`mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeTab === 'profile' ? 'border-l-blue-700 text-blue-700' : 'border-transparent'}`}>Profile</li>
                    </ul>
                </div>
                ...
                {activeTab === 'accounts' && (
                            ...
                            <div className="flex items-center">
                                <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
                                    ...
                                    <label htmlFor="login-password-new">
                                        ...
                                        <div className="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-blue-600">
                                            <input type="password" id="login-password-new" className="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="***********" />
                                        </div>
                                    </label>
                                </div>
                    ...
                    {activeTab === 'theme' && 
                        (
        <div className="pt-4">
            <h1 className="py-2 text-2xl font-semibold">Theme Settings</h1>
            <p className="font text-slate-600">Customize the appearance of your application to suit your preferences.</p>
            <hr className="mt-4 mb-8" />
            ...
            <div className="py-4 px-6 bg-gray-100 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-4">Select your preferred colors for various elements of the application.</p>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-col space-y-4">
                        <label className="flex items-center">
                            <span className="w-32 text-gray-600">Primary Color</span>
                            <input type="color" className="ml-4 w-16 h-8 border-0 rounded-md cursor-pointer " />
                        </label>
                        <label className="flex items-center">
                            <span className="w-32 text-gray-600">Secondary Color</span>
                            <input type="color" className="ml-4 w-16 h-8 border-0 rounded-md  cursor-pointer" />
                        </label>
                        <label className="flex items-center">
                            <span className="w-32 text-gray-600">Accent Color</span>
                            <input type="color" className="ml-4 w-16 h-8 border-0 rounded-md cursor-pointer" />
                        </label>
                    </div>
                </div>
            ...
            <div className="py-4 px-6 bg-gray-100 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-4">See how your theme changes look with a live preview.</p>
            ...
            <div className="flex justify-end">
                <button className="mt-4 rounded-lg bg-blue-600 px-4 py-2 text-white">Save Changes</button>
            </div>
        </div>
                        )}
                    ...
                    {activeTab === 'technician' &&
                        (
                            <div className="pt-4">
                                <h1 className="py-2 text-2xl font-semibold">Technician Settings</h1>
                                <p className="font text-slate-600">View and manage technician details.</p>
                                <hr className="mt-4 mb-8" />
                                ...
                                <table className="min-w-full bg-white border border-gray-200">
                                    <thead>
                                        <tr className="w-full bg-gray-100 border-b">
                                            ...
                                            <th className="py-2 px-4 text-left text-gray-600">Skills</th>
                                            <th className="py-2 px-4 text-left text-gray-600">Current Workload</th>
                                            <th className="py-2 px-4 text-left text-gray-600">Finished So Far</th>
                                            <th className="py-2 px-4 text-left text-gray-600">Rating Average</th>
                                    ...
                                    <tbody>
                                        <tr className="border-b">
                                            <td className="py-2 px-4">Abebeb</td>
                                            <td className="py-2 px-4">Software</td>
                                            <td className="py-2 px-4">5</td>
                                            <td className="py-2 px-4">18</td>
                                            <td className="py-2 px-4">8.9</td>
                                            <td className="py-2 px-4">abebeb@example.com</td>
                                            <td className="py-2 px-4">********</td>
                                            <td className="py-2 px-4">
                                                <button className="text-blue-600 mr-4" title="Update">✏️</button>
                                                <button className="text-rose-600" title="Delete">🗑️</button>
                                            </td>
                                        </tr>
                                        <tr className="border-b">
                                            ...
                                            <td className="py-2 px-4">jane.doe@example.com</td>
                                            <td className="py-2 px-4">********</td>
                                            <td className="py-2 px-4">
                                                <button className="text-blue-600 mr-4" title="Update">✏️</button>
                                                <button className="text-rose-600" title="Delete">🗑️</button>
                                        ...
                                        <tr className="border-b">
                                            ...
                                            <td className="py-2 px-4">Network</td>
                                            <td className="py-2 px-4">3</td>
                                            <td className="py-2 px-4">12</td>
                                            <td className="py-2 px-4">9.2</td>
                                            <td className="py-2 px-4">john.smith@example.com</td>
                                            <td className="py-2 px-4">********</td>
                                            <td className="py-2 px-4">
                                                <button className="text-blue-600 mr-4" title="Update">✏️</button>
                                                <button className="text-rose-600" title="Delete">🗑️</button>
                                ...
                                <div className="flex justify-end mt-4">
                                    <button className="rounded-lg bg-blue-600 px-4 py-2 text-white">Add New Technician</button>
                                </div>
           ...
           <li>
             ...
             >
               Next
                    ...
                    {activeTab === 'department-heads' && 

                        (
                            <div className="pt-4">
                                <h1 className="py-2 text-2xl font-semibold">Department Head Settings</h1>
                                <p className="font text-slate-600">View and manage Department Head details.</p>
                                <hr className="mt-4 mb-8" />
                                ...
                                <table className="min-w-full bg-white border border-gray-200">
                                    <thead>
                                        <tr className="w-full bg-gray-100 border-b">
                                            ...
                                            <th className="py-2 px-4 text-left text-gray-600">Approved</th>
                                            <th className="py-2 px-4 text-left text-gray-600">Updated</th>
                                            <th className="py-2 px-4 text-left text-gray-600">Rejected</th>
                                            <th className="py-2 px-4 text-left text-gray-600">Higher Form's</th>
                                    ...
                                    <tbody>
                                        <tr className="border-b">
                                            ...
                                            <td className="py-2 px-4">Block 15 - room 9</td>
                        ...
                        (
                            <div className="pt-4">
                                ...
                                <div className="w-full p-3 mt-8 bg-white rounded flex">
                                    <div tabIndex="0" aria-label="heart icon" role="Image" className="focus:outline-none w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center">
                                    ...
                                    <div className="pl-3">
                                        <p tabIndex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">James Doe</span> has sent you a <span className="text-indigo-700">completed work message</span></p>
                                ...
                                <div className="w-full p-3 mt-4 bg-white rounded shadow flex flex-shrink-0">
                                    <div tabIndex="0" aria-label="group icon" role="Image" className="focus:outline-none w-8 h-8 border rounded-full border-gray-200 flex flex-shrink-0 items-center justify-center">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <div className="pl-3 w-full">
                                        <div className="flex items-center justify-between w-full">
                                            <p tabIndex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">Sash</span> Gave a bad rating to technician <span className="text-indigo-700">Belete</span></p>
                                ...
                                <div className="w-full p-3 mt-4 bg-white rounded flex">
                                    <div tabIndex="0" aria-label="post icon" role="Image" className="focus:outline-none w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="pl-3">
                                        <p tabIndex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">Sarah</span> from depatment Development: <span className="text-indigo-700">Approved a request</span></p>
                                        <p tabIndex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                                    </div>
                                </div>
                                <div className="w-full p-3 mt-4 bg-red-100 rounded flex items-center">
                                    <div tabIndex="0" aria-label="storage icon" role="Image" className="focus:outline-none w-8 h-8 border rounded-full border-red-200 flex items-center flex-shrink-0 justify-center">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="pl-3 w-full flex items-center justify-between">
                                        <p tabIndex="0" className="focus:outline-none text-sm leading-none text-red-700">Rating's this day are bad: 5/10 rating on average</p>
                                        <p tabIndex="0" className="focus:outline-none text-xs leading-3 cursor-pointer underline text-right text-red-700">Manage</p>
                                    </div>
                                </div>
                                <div className="w-full p-3 mt-4 bg-white rounded flex">
                                    <div tabIndex="0" aria-label="loading icon" role="Image" className="focus:outline-none w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <div className="pl-3">
                                        <p tabIndex="0" className="focus:outline-none text-sm leading-none">Technician belete has sent you a message<span className="text-indigo-700"> on chatting </span></p>
                                        <p tabIndex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                                    </div>
                                </div>
                                ...
                                <div className="w-full p-3 mt-8 bg-green-100 rounded flex items-center">
                                    <div tabIndex="0" aria-label="success icon" role="Image" className="focus:outline-none w-8 h-8 border rounded-full border-green-200 flex flex-shrink-0 items-center justify-center">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="pl-3 w-full">
                                        <div className="flex items-center justify-between">
                                            <p tabIndex="0" className="focus:outline-none text-sm leading-none text-green-700">Rating were so good: 8/10 on average</p>
                            ...
                            <div className="pt-4">
                               ...
                               <div className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
                                    <div className="rounded-t-lg h-32 overflow-hidden">
                                        <Image height={130}
            width={130} className="object-cover object-top w-full" src='/backgroundlessAi.png' alt='Mountain' />
                                    </div>
                                    <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
                                        <Image  height={130}
            width={130} className="object-cover object-center h-32" src='/backgroundlessAi.png' alt='Woman looking front' />
                                    </div>
                                    <div className="text-center mt-2">
                                        <h2 className="font-semibold">Dave </h2>
                                        <p className="text-gray-500">Maintainance Head</p>
                                    </div>
                                    <ul className="py-4 mt-2 text-gray-700 flex items-center justify-around">
                                        <li className="flex flex-col items-center justify-around">
                                            ...
                                            <div className='flex justify-center'><p>2k </p> <br/> </div>
                                            <div className='flex justify-center'><p className='text-sm'>request's</p></div>
                                        </li>
                                        <li className="flex flex-col items-center justify-between">
                                            ...
                                            <div className='flex justify-center'><p>150 </p> <br/> </div>
                                            <div className='flex justify-center'><p className='text-sm'>Technician's</p></div>
                                        </li>
                                        <li className="flex flex-col items-center justify-around">
                                            <svg className="w-4 fill-current text-blue-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                                <path
                                            ...
                                            <div className='flex justify-center'><p>1.5k </p> <br/> </div>
                                            <div className='flex justify-center'><p className='text-sm'>Completed</p></div>
                                        </li>
                                    </ul>
                                    <div className="p-4 border-t mx-8 mt-2">
                                        <button className="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">profile</button>
                                    </div>
                                </div>
                            </div>
                        )}
