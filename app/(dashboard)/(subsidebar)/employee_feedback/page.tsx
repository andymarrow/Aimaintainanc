...
const EmployeeFeedbackPage = () => {
    ...
    return ( 
        ...
        <div className="bg-gray-400 shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col">
            <p className="font-medium">Comments : 
            <span className="ml-4">it was a good work. </span></p>
          </div>
          <div className="flex flex-col">
            <p className="font-medium">Employee Reating :
            <span className="ml-4">my pc had the same defect again.</span></p>
          </div>
